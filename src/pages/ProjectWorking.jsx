    ...
    <div className="max-w-7xl mx-auto p-8 animate-slide-up">
      ...
      <div className="resume-card animate-delay-100">
        ...
        <div className="space-y-8">
          ...
          <div>
            <div className="flex justify-between items-baseline mb-3">
              <h3 className="font-bold text-lg">IoT Project</h3>
                  ...
                  {[
                    ...
                    >
                      ...
                      <div className="absolute bottom-0 inset-x-0 bg-white/90 backdrop-blur-sm p-2 transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                        <p className="text-xs font-semibold text-center text-gray-800 truncate px-2">{img.label}</p>
                      </div>
                    </div>
                  ))}
                </div>
          ...
          <div>
            <div className="flex justify-between items-baseline mb-3">
              <h3 className="font-bold text-lg">Project & Working Web-Framework</h3>
          ...
          <div>
            <div className="flex justify-between items-baseline mb-3">
              <h3 className="font-bold text-lg">Project AI</h3>
              <span className="resume-date">[2023-2025]</span>
            </div>
            <div className="space-y-2">
              <div className="resume-list-item">
          ...
          <div>
            <div className="flex justify-between items-baseline mb-3">
              <h3 className="font-bold text-lg">Project UX/UI</h3>
              <span className="resume-date">[2021-2024]</span>
            </div>
            <div className="space-y-2">
              <div className="resume-list-item">
